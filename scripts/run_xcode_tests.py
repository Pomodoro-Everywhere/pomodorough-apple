...
CONTAINMENT_BOOTOUT_CLEANUP_RESERVE_SECONDS = LAUNCHCTL_PROCESS_CLEANUP_SECONDS
CONTAINMENT_ABSENCE_RESERVE_SECONDS = (
    LAUNCHCTL_AUTHENTICATION_SECONDS
    + LAUNCHCTL_RETRY_SECONDS
    + LAUNCHCTL_PROCESS_CLEANUP_SECONDS
)
CONTAINED_JOB_CLEANUP_SECONDS = (
    CONTAINMENT_SIGNAL_RESERVE_SECONDS
    + CONTAINMENT_DRAIN_RESERVE_SECONDS
    + CONTAINMENT_BOOTOUT_RESERVE_SECONDS
    + CONTAINMENT_BOOTOUT_CLEANUP_RESERVE_SECONDS
    + CONTAINMENT_ABSENCE_RESERVE_SECONDS
)
LIFECYCLE_BOOTSTRAP_SECONDS = 10.0
LIFECYCLE_CLEANUP_SECONDS = CONTAINED_JOB_CLEANUP_SECONDS
